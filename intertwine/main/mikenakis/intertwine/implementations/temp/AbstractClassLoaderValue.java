...
//XXX import jdk.internal.access.JavaLangAccess;
//XXX import jdk.internal.access.SharedSecrets;
//XXX import jdk.internal.loader.BootLoader;
...
/**
 * AbstractClassLoaderValue is a superclass of root-{@link jdk.internal.loader.ClassLoaderValue}
...
public abstract class AbstractClassLoaderValue<CLV extends AbstractClassLoaderValue<CLV,V>, V>
{
	 ...
	 * the root-{@link jdk.internal.loader.ClassLoaderValue} is the ClassLoaderValue itself,
	...
	public V putIfAbsent( ClassLoader cl, V v )
	{
		...
		@SuppressWarnings( "unchecked" ) CLV clv = (CLV)this;
		while( true )
		{
			try
			{
	 ...
	 */
	@SuppressWarnings( "unchecked" ) private static <CLV extends AbstractClassLoaderValue<CLV,?>> ConcurrentHashMap<CLV,Object> map( ClassLoader cl )
	{
		return null; //XXX (ConcurrentHashMap<CLV,Object>)(cl == null ? BootLoader.getClassLoaderValueMap() : JLA.createOrGetClassLoaderValueMap( cl ));
	}
	 ...
	 */
	@SuppressWarnings( "unchecked" ) private V extractValue( Object memoizerOrValue )
	{
	...
	private static final class Memoizer<CLV extends AbstractClassLoaderValue<CLV,V>, V> implements Supplier<V>
	{
		...
		@Override public V get() throws RecursiveInvocationException
		{
			V v = this.v;
			if( v != null )
				return v;
	...
	public final class Sub<K> extends AbstractClassLoaderValue<Sub<K>,V>
	{
		 ...
		 */
		@Override public boolean isEqualOrDescendantOf( AbstractClassLoaderValue<?,V> clv )
		{
		...
		@Override public boolean equals( Object o )
		{
			if( this == o )
				return true;
			if( !(o instanceof AbstractClassLoaderValue.Sub) )
				return false;
			@SuppressWarnings( "unchecked" ) AbstractClassLoaderValue.Sub that = (AbstractClassLoaderValue.Sub)o;
