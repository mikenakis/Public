 ...
 */
public final class ImmutableTypeImmutabilityAssessment extends TypeImmutabilityAssessment
{
	public ImmutableTypeImmutabilityAssessment( Stringizer stringizer )
	{
		super( stringizer );
	}
