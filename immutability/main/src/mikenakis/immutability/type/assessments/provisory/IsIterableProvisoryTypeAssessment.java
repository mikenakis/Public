 ...
 */
public final class IsIterableProvisoryTypeAssessment extends ProvisoryTypeAssessment
{
	public final Mode mode;

	public IsIterableProvisoryTypeAssessment( Stringizer stringizer, Mode mode, Class<? extends Iterable<?>> type )
	{
