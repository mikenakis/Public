 ...
 */
public final class IsCompositeProvisoryTypeImmutabilityAssessment<T,E> extends ProvisoryTypeImmutabilityAssessment
{
	public final Mode mode;
	public final Decomposer<T,E> decomposer;

	public IsCompositeProvisoryTypeImmutabilityAssessment( Stringizer stringizer, Mode mode, Class<T> type, Decomposer<T,E> decomposer )
	{
