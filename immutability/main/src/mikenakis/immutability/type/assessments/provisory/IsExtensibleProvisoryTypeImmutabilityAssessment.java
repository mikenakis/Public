 ...
 */
public final class IsExtensibleProvisoryTypeImmutabilityAssessment extends ProvisoryTypeImmutabilityAssessment
{
	public final Mode mode;

	public IsExtensibleProvisoryTypeImmutabilityAssessment( Stringizer stringizer, Mode mode, Class<?> jvmClass )
	{
