...
/**
 * Signifies that an array field cannot be conclusively assessed as mutable or immutable because each element must also be assessed.
 * (It has already been established that the field is either {@code final} or annotated with @{@link InvariableField} and also that it
 * has been annotated with @{@link InvariableArray}.
 */
public final class ArrayFieldAssessment extends ProvisoryFieldAssessment
{
	public final ProvisoryTypeAssessment arrayElementTypeAssessment;

	public ArrayFieldAssessment( Stringizer stringizer, Field field, ProvisoryTypeAssessment arrayElementTypeAssessment )
	{
	...
	@ExcludeFromJacocoGeneratedReport @Override protected void appendToStringBuilder( StringBuilder stringBuilder )
	{
		...
		stringBuilder.append( " because it is an array of provisory element type '" ).append( stringizer.stringize( arrayElementTypeAssessment.type ) ).append( "'" );
	}
}
