 ...
 */
public final class HasMutableIterableElementMutableObjectAssessment<E> extends MutableObjectAssessment
{
	public final Iterable<E> iterableObject;
	public final IsIterableProvisoryTypeAssessment typeAssessment;
	public final int mutableElementIndex;
	public final E mutableElement;
	public final MutableObjectAssessment elementAssessment;

	public HasMutableIterableElementMutableObjectAssessment( Stringizer stringizer, Iterable<E> iterableObject, IsIterableProvisoryTypeAssessment typeAssessment, //
