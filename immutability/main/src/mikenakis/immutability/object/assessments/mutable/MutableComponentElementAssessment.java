 ...
 */
public final class MutableComponentElementAssessment<T,E> extends MutableObjectAssessment
{
	...
	public MutableComponentElementAssessment( Stringizer stringizer, T compositeObject, ProvisoryCompositeAssessment<T,E> typeAssessment, //
