		...
		return switch( opCode )
			{
				...
				case OpCode.ICONST_M1, OpCode.DCONST_1, OpCode.DCONST_0, OpCode.FCONST_2, OpCode.FCONST_1, OpCode.FCONST_0, OpCode.LCONST_1, OpCode.LCONST_0, //
					...
					Group.OperandlessLoadConstant;
				case OpCode.BIPUSH, OpCode.SIPUSH -> //
					Group.ImmediateLoadConstant;
				case OpCode.LDC, OpCode.LDC_W, OpCode.LDC2_W -> //
					Group.IndirectLoadConstant;
				...
				case OpCode.GOTO, OpCode.GOTO_W, OpCode.JSR, OpCode.JSR_W -> //
					Group.Branch;
				case OpCode.TABLESWITCH -> Group.TableSwitch;
				case OpCode.LOOKUPSWITCH -> Group.LookupSwitch;
				case OpCode.GETSTATIC, OpCode.INSTANCEOF, OpCode.CHECKCAST, OpCode.ANEWARRAY, OpCode.NEW, OpCode.INVOKESTATIC, OpCode.INVOKESPECIAL, //
					...
					Group.ConstantReferencing;
				case OpCode.INVOKEINTERFACE -> Group.InvokeInterface;
				case OpCode.INVOKEDYNAMIC -> Group.InvokeDynamic;
				case OpCode.NEWARRAY -> Group.NewPrimitiveArray;
				case OpCode.MULTIANEWARRAY -> Group.MultiANewArray;
