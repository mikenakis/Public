...
public class T401_Generating
{
	...
	{
		Mutf8Constant thisClassName = Mutf8Constant.of( "HelloWorld" );
		...
		PlainMethodReferenceConstant initMethodReferenceConstant = PlainMethodReferenceConstant.of( thisClassConstant, initMethodNameAndDescriptorConstant );
		...
		PlainMethodReferenceConstant parseMethodReferenceConstant = PlainMethodReferenceConstant.of( thisClassConstant, parseMethodNameAndDescriptorConstant );
