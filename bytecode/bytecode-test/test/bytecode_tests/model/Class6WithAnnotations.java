...
public abstract class Class6WithAnnotations
{
	...
	@RuntimeVisibleAnnotation1( booleanParameter = false, byteParameter = (byte)2, charParameter = 'd', doubleParameter = 0.1, floatParameter = 0.2f, intParameter = 3, longParameter = 0x1_0000_0000L, shortParameter = (short)1000 )
	...
	@SuppressWarnings( "MethodMayBeStatic" ) public final void methodWithParameterAnnotations( int a, @RuntimeVisibleAnnotation1( stringParameter = "g" ) int b, @RuntimeVisibleAnnotation1( stringParameter = "h" ) @RuntimeInvisibleAnnotation1( 1 ) int c )
	{
