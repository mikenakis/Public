...
public class Buffer
{
	...
	public static Buffer create( byte[] bytes, int start, int length )
	{
		if( length == 0 )
			return EMPTY;
	...
	public static Buffer create( String s )
	{
	...
	public final Object _debugView = new Object()
	{
	...
	{
		return Objects.hash( Arrays.hashCode( bytes ), offset, length ); //no need to hash the length.
	}
}
